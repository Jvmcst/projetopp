...
// @DeleteMapping({"", "/"})
// public List<Promocao> deleteByUsuario(@PathVariable("idUsuario") int
// idUsuario) {
// List<Promocao> promocaoList = usuariopromoservice.getByUsuario(idUsuario);
// if (promocaoList == null || promocaoList.isEmpty()) {
// throw new RuntimeException("Nao existe usuario com este id para ser
// excluido....");
// }
...
// Promocao promocao = usuariopromoservice.get(idUsuario, idPromocao);
// if (promocao == null) {
// throw new RuntimeException("Nao existe promocao com este id para ser
// excluido....");
// }
